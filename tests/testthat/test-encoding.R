test_that("front_matter_read handles UTF-8 with multibyte characters", {
  skip_if_not_installed("yaml12")

  path <- test_path("fixtures", "yaml-utf8.md")
  result <- front_matter_read(path)
...
test_that("front_matter_read strips UTF-8 BOM", {
  skip_if_not_installed("yaml12")
...
test_that("front_matter_read handles CRLF line endings", {
  skip_if_not_installed("yaml12")
...
test_that("front_matter_read handles file without front matter", {
...
test_that("front_matter_read handles empty file", {
...
test_that("front_matter_text handles UTF-8 multibyte in content", {
  skip_if_not_installed("yaml12")
